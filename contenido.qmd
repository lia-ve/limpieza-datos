...
Acá se presentan valores atípicos (la edad de Santiago), además de un valor faltante (el color favorito de Valentina). ¿Qué otros problemas identificas?
...
Acá lo que se hace es especificar como debería leer la estampilla de tiempo: %d corresponde al día, %m corresponde al més, %Y corresponde al año, y así sucesivamente.
